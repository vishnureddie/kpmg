	      ...
	      <aui:form  action="<%=manageFormsURL%>" method="post" name="fm">
	       ...
	       <div class="col-md-6">
	        ...
	        <div class="form-group"> 
	         ...
	         <liferay-ui:input-editor name="hmlmainDescription"  initMethod="initEditor" width="50" height="20" resizable="true">
	       ...
	       <div class="form-group"> 
	         ...
	         <liferay-ui:input-editor name="hi_hmlmainDescription"  initMethod="initEditor" width="50" height="20" resizable="true">
             </liferay-ui:input-editor>   
        </div>
